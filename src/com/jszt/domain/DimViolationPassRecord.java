/*
 * 文件名：ateReal.java  1.0.0  2015年5月14日
 * 描述：&功能说明
 * 作者：常骏
 * 版权：江苏智通交通科技有限公司
 */
 ...
 * @since      [产品/模块版本] 
 */
public class DimViolationPassRecord extends EhsObject implements Serializable
{
    /**
     * 
     */
    private static final long serialVersionUID = -54396589291731653L;
    ...
    public  DimViolationPassRecord()
    {
        
    }
    
    public  DimViolationPassRecord(PassRecord passRecord,String cardType,int areaId)
    {
